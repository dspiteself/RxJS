...
Rx.Notification = function(kind, hasValue) {
	this.hasValue = hasValue == null ? false : hasValue;
	this.kind = kind;
}

/**
 * Invokes the delegate corresponding to the notification or the observer's
 * method corresponding to the notification and returns the produced result.
 * 
 * @memberOf Notification
 * @param {Any}
 *            observerOrOnNext Delegate to invoke for an OnNext notification or
 ...
 */
Rx.Notification.prototype.accept = function(observerOrOnNext, onError,
		onCompleted) {
 ...
 * @returns {Observable} The observable sequence that surfaces the behavior of
 *          the notification upon subscription.
 */
 ...
 */
Rx.Notification.createOnNext = (function() {
	...
	return function(value) {
		var notification = new Rx.Notification('N', true);
 ...
 */
Rx.Notification.createOnError = (function() {
	...
	return function(exception) {
		var notification = new Rx.Notification('E');
